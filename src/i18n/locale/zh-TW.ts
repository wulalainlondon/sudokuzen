...
export const zhTW = {
  ...
  duoRuntime: {
    ...
    opponentCompleteTitle: '{alias} 已完成',
    opponentCompleteChase: '最後追趕 · 完成你的棋盤',
    forfeit: '認輸',
    surrender: '投降',
    finishedFirst: '你已完成！等待對手結果...',
    resultWin: '勝',
    resultLose: '敗',
    resultDominantWinTitle: '大勝',
    resultCloseWinTitle: '險勝',
    resultVictoryTitle: '勝利',
    resultLossTitle: '落敗',
    resultCloseLossTitle: '惜敗',
    resultDominantLossTitle: '慘敗',
    resultForfeitWinTitle: '勝利',
    resultForfeitLossTitle: '已認輸',
    resultAbandonedTitle: '對局中止',
    resultDrawTitle: '平手',
    resultDraw: '平手！心有靈犀 💕',
    resultFaster: '{winner} 快了 {diff}',
    resultCloseGap: '僅差 {diff}，勝負就在一瞬間',
    resultDominantGap: '{winner} 領先 {diff} 完成',
    resultAbandoned: '雙方均未完成，本局不列入戰績',
    resultForfeitTime: '認輸',
    resultOpponentForfeit: '對手認輸',
    resultYouForfeit: '你已認輸，本局不比較時間差',
    historyRecord: '歷史戰績：',
  ...
  skills: {
    ...
    finnedXWingName: '裂鋒',
    finnedSwordfishName: '荊棘',
    finnedJellyfishName: '鰭水母',
    xCycleSimpleColoringName: '流彩',
    xyChainName: '雙值連環',
    aicName: '玄鏈',
    aicLongChainName: '破執',
    aicMidChainName: '玄鏈·中',
    groupedAicNiceLoopName: '環鏈',
    discontinuousNiceLoopName: '斷環',
    cellForcingChainName: '格逼',
    regionForcingChainName: '域逼',
    forcingChainNetName: '逼宮',
    alsXZName: '殘集·交',
    alsXYName: '殘集·合',
    alsWWingName: '殘集·弦',
    alsChainName: '殘集·鏈',
    ...
    noXCycleSimpleColoring: '未構成流彩',
    noXYChain: '未構成雙值連環',
    noAIC: '未構成玄鏈',
    noAICLongChain: '未構成破執',
    noAICMidChain: '未構成玄鏈·中',
    noNiceLoop: '未構成環鏈',
    noDiscontinuousNiceLoop: '未構成斷環',
    noCellForcingChain: '未構成格逼',
    noRegionForcingChain: '未構成域逼',
    noForcingChain: '未構成逼宮',
    mustBeSameUnit: '所選格需在同一列/欄/宮',
    mustBeSameBox: '所選格需在同一宮',
    mustBeLineAndBox: '所選格需同時在同一列/欄與同一宮',
    noCommonDigit: '所選格無共同候選數字',
    noALSXZ: '未構成殘集·交',
    noALSXY: '未構成殘集·合',
    noALSWWing: '未構成殘集·弦',
    noALSChain: '未構成殘集·鏈',
