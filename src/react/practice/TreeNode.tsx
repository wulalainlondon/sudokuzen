...
const TECH_ICONS: Record<string, ReactElement> = {
  // ── Foundation ─────────────────────────────────────────────────────
  naked_single: ( // Eye — seeing the only possibility
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="32" cy="32" rx="18" ry="12" /><circle cx="32" cy="32" r="5" />
    </svg>
  ),
  hidden_single: ( // Half-closed eye — hidden observation
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M14 32c6-10 14-14 18-14s12 4 18 14" /><circle cx="32" cy="32" r="5" />
      <path d="M14 32c6 10 14 14 18 14" strokeDasharray="4 3" />
    </svg>
  ),
  locked_candidates: ( // Padlock with grid line
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="20" y="30" width="24" height="18" rx="3" /><path d="M26 30v-6a6 6 0 0 1 12 0v6" />
      <line x1="12" y1="39" x2="52" y2="39" strokeDasharray="3 3" />
    </svg>
  ),
  naked_pair: ( // Two circles linked
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="24" cy="32" r="8" /><circle cx="40" cy="32" r="8" />
      <line x1="32" y1="28" x2="32" y2="36" />
    </svg>
  ),
  hidden_pair: ( // Two dashed circles linked
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="24" cy="32" r="8" strokeDasharray="4 3" /><circle cx="40" cy="32" r="8" strokeDasharray="4 3" />
      <line x1="32" y1="28" x2="32" y2="36" />
    </svg>
  ),
  naked_triple: ( // Three circles in triangle
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="20" r="7" /><circle cx="22" cy="38" r="7" /><circle cx="42" cy="38" r="7" />
      <path d="M32 27v4M26 35l-1-1M38 35l1-1" />
    </svg>
  ),
  hidden_triple: ( // Three dashed circles in triangle
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="20" r="7" strokeDasharray="4 3" /><circle cx="22" cy="38" r="7" strokeDasharray="4 3" /><circle cx="42" cy="38" r="7" strokeDasharray="4 3" />
      <path d="M32 27v4M26 35l-1-1M38 35l1-1" />
    </svg>
  ),

  // ── Fish family ────────────────────────────────────────────────────
  x_wing: ( // X cross — two parallel lines crossing
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M16 16l32 32M48 16L16 48" /><circle cx="16" cy="16" r="3" /><circle cx="48" cy="16" r="3" />
      <circle cx="16" cy="48" r="3" /><circle cx="48" cy="48" r="3" />
    </svg>
  ),
  finned_x_wing: ( // X cross with extra fin mark
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M16 16l32 32M48 16L16 48" /><circle cx="16" cy="16" r="3" /><circle cx="48" cy="16" r="3" />
      <circle cx="16" cy="48" r="3" /><circle cx="48" cy="48" r="3" />
  ...
  jellyfish: ( // Dome + trailing tendrils
    <svg viewBox="0 0 64 64" aria-hidden="true">
  ...
  finned_jellyfish: ( // Jellyfish with fin mark
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M14 30c0-12 8-18 18-18s18 6 18 18" />
      <path d="M18 30c2 8 2 16 0 22M26 30c1 8 1 16 0 22M34 30c-1 8-1 16 0 22M42 30c-2 8-2 16 0 22" />
  ...
  skyscraper: ( // Two towers connected at top
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M20 50V18h8v32M36 50V24h8v26" />
      <path d="M24 18h16" strokeDasharray="3 2" />
    </svg>
  ),
  two_string_kite: ( // Kite shape with two strings
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M32 12L48 32 32 52 16 32z" /><path d="M32 52l-8 6M32 52l8 6" />
    </svg>
  ),
  empty_rectangle: ( // Rectangle with empty center
    <svg viewBox="0 0 64 64" aria-hidden="true">
  ...
  // ── Wings ──────────────────────────────────────────────────────────
  w_wing: ( // W shape — wave wing
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M12 20l10 24 10-16 10 16 10-24" />
    </svg>
  ),
  xy_wing: ( // Y-branching from center
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="32" r="5" /><path d="M32 27V14M27 35l-12 10M37 35l12 10" />
    </svg>
  ),
  xyz_wing: ( // Three branches from center
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="32" r="5" /><path d="M32 27V14M27 35l-12 10M37 35l12 10" />
      <circle cx="32" cy="14" r="3" /><circle cx="15" cy="45" r="3" /><circle cx="49" cy="45" r="3" />
    </svg>
  ),

  // ── Rectangles & special patterns ──────────────────────────────────
  unique_rectangle: ( // Rectangle with diagonal slash
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="14" y="18" width="36" height="28" rx="2" /><path d="M14 46l36-28" />
    </svg>
  ),
  bug_plus_one: ( // Bug shape + "1"
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="28" cy="34" rx="12" ry="14" /><path d="M16 28l-4-6M40 28l4-6M28 20v-6" />
      <text x="47" y="48" fontSize="16" fontWeight="700" fill="currentColor" stroke="none">1</text>
    </svg>
  ),

  // ── Coloring & Chains ──────────────────────────────────────────────
  x_cycle_simple_coloring: ( // Yin-yang — two colors
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="32" r="18" /><path d="M32 14a18 18 0 0 1 0 36" />
      <circle cx="32" cy="23" r="4" /><circle cx="32" cy="41" r="4" strokeDasharray="3 2" />
    </svg>
  ),
  remote_pairs: ( // Two dots connected by long dashed line
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="14" cy="32" r="5" /><circle cx="50" cy="32" r="5" />
      <path d="M19 32h26" strokeDasharray="4 3" />
    </svg>
  ),
  xy_chain: ( // Chain of linked nodes
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="14" cy="32" r="4" /><circle cx="28" cy="22" r="4" /><circle cx="42" cy="38" r="4" /><circle cx="52" cy="26" r="4" />
      <path d="M18 30l6-6M32 24l6 12M46 36l4-8" />
    </svg>
  ),
  medusa_3d: ( // Three-headed — 3D coloring
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="38" r="6" />
      <path d="M32 32c-4-6-12-10-14-6M32 32c4-6 12-10 14-6M32 32v-14" />
      <circle cx="18" cy="22" r="3" /><circle cx="46" cy="22" r="3" /><circle cx="32" cy="16" r="3" />
    </svg>
  ),
  aic: ( // Alternating strong-weak chain
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="12" cy="32" r="4" /><circle cx="32" cy="32" r="4" /><circle cx="52" cy="32" r="4" />
      <line x1="16" y1="32" x2="28" y2="32" /><line x1="36" y1="32" x2="48" y2="32" strokeDasharray="3 2" />
    </svg>
  ),
  aic_mid_chain: ( // Chain with middle emphasis
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="12" cy="32" r="3" /><circle cx="26" cy="24" r="3" /><circle cx="38" cy="40" r="3" /><circle cx="52" cy="32" r="3" />
      <path d="M15 31l8-6M29 26l6 12M41 38l8-5" />
      <circle cx="32" cy="32" r="8" strokeDasharray="3 3" />
    </svg>
  ),
  aic_long_chain: ( // Long zigzag chain
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M10 40l8-16 8 16 8-16 8 16 8-16 4 8" />
      <circle cx="10" cy="40" r="3" /><circle cx="54" cy="32" r="3" />
    </svg>
  ),
  grouped_aic_nice_loop: ( // Closed loop with grouped nodes
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="32" cy="32" rx="18" ry="16" strokeDasharray="6 3" />
      <circle cx="14" cy="32" r="3" /><circle cx="32" cy="16" r="3" /><circle cx="50" cy="32" r="3" /><circle cx="32" cy="48" r="3" />
    </svg>
  ),
  discontinuous_nice_loop: ( // Broken loop
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M32 14a18 18 0 0 1 16 28" /><path d="M48 42a18 18 0 0 1-32-10" strokeDasharray="4 3" />
      <circle cx="32" cy="14" r="3" /><circle cx="48" cy="42" r="3" />
      <path d="M18 34l-4 4" />
    </svg>
  ),
  forcing_chain_net: ( // Central node radiating chains
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="32" r="6" /><path d="M32 26V12M32 38v14M26 32H12M38 32h14" />
      <path d="M27 27L16 16M37 27l11-11M27 37L16 48M37 37l11 11" strokeDasharray="3 2" />
    </svg>
  ),
  cell_forcing_chain: ( // Grid cell with radiating arrows
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="24" y="24" width="16" height="16" rx="2" />
      <path d="M24 32H12M40 32h12M32 24V12M32 40v12" />
    </svg>
  ),
  region_forcing_chain: ( // Region box with radiating arrows
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="18" y="18" width="28" height="28" rx="3" />
      <line x1="18" y1="28" x2="46" y2="28" /><line x1="18" y1="38" x2="46" y2="38" />
      <line x1="28" y1="18" x2="28" y2="46" /><line x1="38" y1="18" x2="38" y2="46" />
      <path d="M32 12V8M32 52v4M8 32H4M56 32h4" />
    </svg>
  ),

  // ── ALS family ─────────────────────────────────────────────────────
  als_xz: ( // Two overlapping sets
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="26" cy="32" rx="14" ry="16" /><ellipse cx="38" cy="32" rx="14" ry="16" />
    </svg>
  ),
  als_xy: ( // Three overlapping sets
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="24" cy="28" rx="12" ry="14" /><ellipse cx="40" cy="28" rx="12" ry="14" />
      <ellipse cx="32" cy="40" rx="12" ry="14" />
    </svg>
  ),
  als_w_wing: ( // ALS with wing shape
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="22" cy="34" rx="10" ry="12" /><ellipse cx="42" cy="34" rx="10" ry="12" />
      <path d="M22 22l10-10 10 10" />
    </svg>
  ),
  als_chain: ( // Chain of overlapping sets
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <ellipse cx="16" cy="32" rx="8" ry="10" /><ellipse cx="32" cy="32" rx="8" ry="10" /><ellipse cx="48" cy="32" rx="8" ry="10" />
      <path d="M24 32h-1M40 32h-1" />
    </svg>
  ),

  // ── Master / Legend ────────────────────────────────────────────────
  sue_de_coq: ( // Puzzle piece
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M16 22h8c0-4 4-6 8-6s8 2 8 6h8v8c4 0 6 4 6 8s-2 8-6 8v8H16V22z" />
    </svg>
  ),
  template: ( // Grid template overlay
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="14" y="14" width="36" height="36" rx="2" />
      <line x1="14" y1="26" x2="50" y2="26" /><line x1="14" y1="38" x2="50" y2="38" />
      <line x1="26" y1="14" x2="26" y2="50" /><line x1="38" y1="14" x2="38" y2="50" />
      <circle cx="20" cy="20" r="2.5" /><circle cx="44" cy="32" r="2.5" /><circle cx="32" cy="44" r="2.5" />
    </svg>
  ),
  death_blossom: ( // Flower with petals
    <svg viewBox="0 0 64 64" aria-hidden="true">
  ...
  exocet_death_blossom: ( // Crown — ultimate technique
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M12 42l6-20 14 12 14-12 6 20z" /><line x1="12" y1="46" x2="52" y2="46" />
      <circle cx="18" cy="22" r="2" /><circle cx="32" cy="34" r="2" /><circle cx="46" cy="22" r="2" />
    </svg>
  ),
  lock: ( // Lock — for locked nodes
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <rect x="18" y="30" width="28" height="22" rx="4" /><path d="M24 30v-6a8 8 0 0 1 16 0v6M32 38v7" />
    </svg>
  ),
};
...
const FALLBACK_ICON = (
  <svg viewBox="0 0 64 64" aria-hidden="true">
    <path d="M10 44h44L42 20 32 32 22 20z" /><path d="M14 50h36" />
  </svg>
);
